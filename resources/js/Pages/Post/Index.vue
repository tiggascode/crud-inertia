<template>
        ...
        <div class="mb-8">
            <Link :href="route('post.create')" class="hover:bg-white hover:text-sky-500 border border-sky-500 block p-2 w-32 bg-sky-500 rounded-full text-center text-white">App Post</Link>
        </div>
        <div v-if="posts">
            <div  class="mb-8 pt-8 border-t border-gray-300" v-for="post in posts">
                <div>id: {{ post.id }} </div>
